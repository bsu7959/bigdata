...
<body>
    ...
    <form name="regform" id="regform" method="post" action="info_ok.jsp" onsubmit="return sendit()">
        ...
        <p>주민등록번호 : <input type="text" name="ssn1" id="ssn1" maxlength="6" value="<%=mem_ssn1 %>"> - <input type="text" name="ssn2" id="ssn2" maxlength="7" value="<%=mem_ssn2 %>"> <input type="button" value="주민등록번호 검증" id="ssnBtn"></p>
        <p><label>우편번호 : <input type="text" name="zipcode" id="sample6_postcode" placeholder="우편번호" readonly value="<%=mem_zipcode %>"></label> <input type="button" value="우편번호 검색" onclick="sample6_execDaumPostcode()"></p>
